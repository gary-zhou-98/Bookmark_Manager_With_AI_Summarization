...
from app.models import User, Bookmark  # import models
...
config.set_main_option("sqlalchemy.url", str(db_url))  # Convert URL object to string

# add your model's MetaData object here
# for 'autogenerate' support
target_metadata = db.metadata  # metadata for all models
